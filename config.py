...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7555676292:AAHVWaqDnsraVCX7PRJpDB-QCeHQgodgPKA")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "20283139"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "444b8ee3a5c2b58acb259e2cb2719f9f")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002567757987"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Testting1111")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7616413959"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://himmmat1234:b8r1PkMzSNOWV2id@cluster0.m2n4v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "himmmat1234")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002543605811"))
#put 0 to disable
...
try:
    ADMINS=[7967418938]
    for x in (os.environ.get("ADMINS", "7967418938").split()):
        ADMINS.append(int(x))
except ValueError:
